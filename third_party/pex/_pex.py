...
if not zipfile.is_zipfile(sys.argv[0]):
    ...
    root = os.path.join(
        os.sep.join(__file__.split(os.sep)[:-6]), 'third_party/pex/_pex.runfiles/third_party/py')
...
def main():
    ...
    try:
        ...
        interpreter = PythonInterpreter(
            ...
            ('setuptools', '>1.0'): 'third_party/py/setuptools/setuptools-18.0.1-py2.py3-none-any.whl'
            })
